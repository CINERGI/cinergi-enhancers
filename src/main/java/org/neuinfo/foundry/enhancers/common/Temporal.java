...
public class Temporal {
    ...
    private final static Logger logger = Logger.getLogger(Temporal.class);
    private ArrayList<String> existingTemporalExtents;

    static Temporal NULL_TIME = new Temporal();
    ...
    public static void main(String[] args) throws Exception {
       ...
       //props.setProperty("ner.useSUTime", "0");
        ...
        ArrayList dates =  Temporal.getdates("january 2001  to  dec 2010", coreNLP);
