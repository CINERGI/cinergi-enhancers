...
import org.neuinfo.foundry.enhancers.plugins.TitleEnhancer;
 ...
 */
public class TitleEnhancerTest {

    @Test
    public void testTitleEnhancer() throws Exception {
        ...
        Assert.assertTrue(result.getStatus() == Result.Status.OK_WITHOUT_CHANGE);
